...
#     # --------------------------------------------------
#     # Validation globale selon le rôle
#     # --------------------------------------------------
...
#                     "region_id": "Obligatoire pour un directeur de région."
#                 })
...
#             if not region_id:
#                 raise serializers.ValidationError({
#                     "region_id": "Obligatoire pour un responsable de structure."
#                 })
#             if not structure_id:
#                 raise serializers.ValidationError({
#                     "structure_id": "Obligatoire pour un responsable de structure."
#                 })
#             self._verify_region(region_id)
...
#             raise serializers.ValidationError({
#                 "region_id": "Service région indisponible."
#             })

#     # --------------------------------------------------
#     # Vérification structure via Eureka
#     # --------------------------------------------------
...
#             if str(data.get('region')) != str(region_id):
#                 raise serializers.ValidationError({
#                     "structure_id": "Cette structure n'appartient pas à la région."
#                 })

#         except requests.exceptions.RequestException:
#             raise serializers.ValidationError({
#                 "structure_id": "Service structure indisponible."
#             })
...
#         # Générer mot de passe si absent
...
#         # pour récupérer le mdp généré (optionnel)
#         user.generated_password = getattr(self, "generated_password", None)
